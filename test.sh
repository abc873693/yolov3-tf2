...
declare -a experitentDirs=("20200417_4")
#declare -a dataset=("brown128" "green859" "thickBrown1227" "thinGreen1068")
declare -a dataset=("dataset/cfg/shrimp_v5_test.txt")
...
do
    ...
    do
        echo "--------------$data--------------"
        CUDA_VISIBLE_DEVICES=7 python3 detect_dataset.py --weights_postfix $weightName --classes ./data/shrimp.names  --tiny --num_classes 1 --dataset $data --experiment $experitentDir --map
    done
done
